...
func main() {
	...
	internal.LogInfo("===========================================")
	internal.LogInfo("QIANWEN-WEB-01 Server Starting...")
	internal.LogInfo("===========================================")
	...
	http.HandleFunc("/v1/chat/completions", internal.WithRequestLog(internal.HandleChatCompletions))
	http.HandleFunc("/v1/images/generations", internal.WithRequestLog(internal.HandleImageGenerations))
	http.HandleFunc("/v1/video/generations/sync", internal.WithRequestLog(internal.HandleVideoGenerationsSync))
	http.HandleFunc("/v1/videos/generations/sync", internal.WithRequestLog(internal.HandleVideoGenerationsSync))
	http.HandleFunc("/v1/videos", internal.WithRequestLog(internal.HandleVideoGenerations))
	http.HandleFunc("/v1/videos/", internal.WithRequestLog(internal.HandleVideoTask))
	http.HandleFunc("/v1/video/generations", internal.WithRequestLog(internal.HandleVideoGenerations))
	http.HandleFunc("/v1/video/generations/", internal.WithRequestLog(internal.HandleVideoTask))
	http.HandleFunc("/v1/videos/generations", internal.WithRequestLog(internal.HandleVideoGenerations))
	http.HandleFunc("/v1/videos/generations/", internal.WithRequestLog(internal.HandleVideoTask))
	http.HandleFunc("/v1/tasks/", internal.WithRequestLog(internal.HandleGenericTask))
